...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": r"0.18.0",
                "include directory": r"../../tmp/build-env-99e64tom/lib/python3.12/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Build Dependencies": {
            "blas": {
                ...
                "openblas configuration": r"OpenBLAS 0.3.29.dev DYNAMIC_ARCH NO_AFFINITY Haswell MAX_THREADS=64",
        ...
        "Python Information": {
            "path": r"/tmp/build-env-99e64tom/bin/python",
            "version": "3.12",
        },
    }
)
