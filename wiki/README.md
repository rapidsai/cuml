...
We have criteria for defining our [definition of done](DEFINITION_OF_DONE_CRITERIA.md). For running the benchmark suite (with or without cuML installed), see [BENCHMARK.md](BENCHMARK.md). to allow us to provide high performance, maintainable and overall high quality implementations, while giving as much transparency as possible about the status of our algorithms with our users.
