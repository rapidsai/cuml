...
* **Docker**
    ...
    2. Run the following Docker command:
        ...
        docker run --rm --pull always \
            ...
            rapidsai/ci-conda:25.10-latest /opt/repo/ci/run_clang_tidy.sh
        ```
...
* **Conda**
    ...
    2. Create and activate the needed conda environment:
        ```bash
        conda env create --yes -n cuml-clang-tidy -f conda/environments/clang_tidy_cuda-129_arch-x86_64.yaml
