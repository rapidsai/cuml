...
* **Docker**
    ...
    2. Run the following Docker command:
        ...
        docker run --rm --pull always \
            ...
            rapidsai/ci-conda:26.04-latest /opt/repo/ci/run_clang_tidy.sh
        ```
...
* **Conda**
    ...
    2. Create and activate the needed conda environment:
        ```bash
        conda env create --yes -n cuml-clang-tidy -f conda/environments/clang_tidy_cuda-131_arch-$(uname -m).yaml
