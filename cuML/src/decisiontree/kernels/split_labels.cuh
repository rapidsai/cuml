...
template<typename T>
void make_split(T *column, GiniQuestion<T> & ques, const int nrows, int& nrowsleft, int& nrowsright, unsigned int* rowids, int split_algo, const std::shared_ptr<TemporaryMemory<T>> tempmem)
{
