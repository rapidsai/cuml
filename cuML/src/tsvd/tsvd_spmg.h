...
void tsvdFitSPMG(double *h_input, double *h_components, double *h_singular_vals,
        paramsTSVD prms, int *gpu_ids, int n_gpus);
void tsvdInverseTransformSPMG(float *h_trans_input, float *h_components, bool trans_comp,
        float *input, paramsTSVD prms, int *gpu_ids, int n_gpus);
void tsvdInverseTransformSPMG(double *h_trans_input, double *h_components, bool trans_comp,
        double *input, paramsTSVD prms, int *gpu_ids, int n_gpus);
void tsvdTransformSPMG(float *h_input, float *h_components, bool trans_comp,
        float *h_trans_input, paramsTSVD prms, int *gpu_ids, int n_gpus);
void tsvdTransformSPMG(double *h_input, double *h_components, bool trans_comp,
        double *h_trans_input, paramsTSVD prms, int *gpu_ids, int n_gpus);
void tsvdFitTransformSPMG(float *h_input, float *h_trans_input,
        float *h_components, float *h_explained_var,
        float *h_explained_var_ratio, float *h_singular_vals, paramsTSVD prms,
...
void tsvdFitTransformSPMG(double *h_input, double *h_trans_input,
        ...
        double *h_explained_var_ratio, double *h_singular_vals, paramsTSVD prms,
        int *gpu_ids, int n_gpus);
