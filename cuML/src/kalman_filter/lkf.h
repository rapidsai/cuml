...
template <typename T>
void set(Variables<T>& var, int _dim_x, int _dim_z, Option _solver, T *_x_est, T *_x_up,
         T *_Phi, T *_P_est, T *_P_up, T *_Q, T *_R, T *_H, void* workspace,
         size_t& workspaceSize, cusolverDnHandle_t handle_sol) {
