...
class TruncatedSVD:
    ...
    def fit_transform(self, X):
        """
            ...
            Notice transformation is same as PCA projection (X @ VT.T[:n_components])
    ...
    def inverse_transform(self, X):
        """
            ...
            Notice transformation is same as PCA reverse double projection 
            transformed = (X @ VT.T[:n_components]), inverse = transformed @ VT
