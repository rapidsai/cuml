...
"""
Test suite to ensure that the new FIL remains backwards-compatible with
old user code using the legacy FIL.

In the future, when the deprecation cycle completes, the suite should be
removed.
"""
