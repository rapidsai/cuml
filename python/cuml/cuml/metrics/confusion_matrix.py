...
def _compute_confusion_matrix(
    y_true, y_pred, sample_weight, labels, normalize=None
):
    """A shared helper to compute the confusion matrix for already validated
    input arrays.

    Shared between `cuml.metrics.confusion_matrix` and
...
def confusion_matrix(
    ...
    return _compute_confusion_matrix(
        y_true, y_pred, sample_weight, labels, normalize=normalize
    )
