...
#
"""Device-aware Pipeline implementation for cuml.accel (keeps intermediate data on device)."""
...
class Pipeline(_SklearnPipeline, InteropMixin):
    ...
    def fit(self, X, y=None, **params):
        if not _routing_enabled() and getattr(
        ...
        with _print_elapsed_time(
            ...
            if self._final_estimator != "passthrough":
                ...
                if not self._is_accelerated(self._final_estimator):
                    Xt = _to_numpy_if_device(Xt)
