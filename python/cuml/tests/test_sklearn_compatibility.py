...
XFAILS = {
    ...
    GaussianRandomProjection: {
        "check_estimator_tags_renamed": "No support for modern tags infrastructure",
        "check_n_features_in_after_fitting": "GaussianRandomProjection doesn't check n_features_in_",
    ...
    SparseRandomProjection: {
        "check_estimator_tags_renamed": "No support for modern tags infrastructure",
        "check_n_features_in_after_fitting": "SparseRandomProjection doesn't check n_features_in_",
