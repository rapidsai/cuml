...
PER_ESTIMATOR_XFAIL_CHECKS = {
    ...
    BernoulliNB: {
        "check_estimator_tags_renamed": "No support for modern tags infrastructure",
        "check_no_attributes_set_in_init": "BernoulliNB sets attributes during init",
        "check_estimators_unfitted": "BernoulliNB does not raise NotFittedError before fit",
        "check_do_not_raise_errors_in_init_or_set_params": "BernoulliNB raises errors in init or set_params",
        ...
        "check_sample_weights_list": "BernoulliNB does not handle list sample weights",
        ...
        "check_complex_data": "BernoulliNB does not handle complex data",
        ...
        "check_parameters_default_constructible": "BernoulliNB parameters are mutated on init",
        "check_fit1d": "BernoulliNB does not raise ValueError for 1D input",
        "check_fit2d_predict1d": "BernoulliNB does not handle 1D prediction input gracefully",
        "check_fit_check_is_fitted": "BernoulliNB passes check_is_fitted before being fit",
        "check_requires_y_none": "BernoulliNB does not require y for fit",
    },
    ComplementNB: {
        "check_estimator_tags_renamed": "No support for modern tags infrastructure",
        "check_no_attributes_set_in_init": "ComplementNB sets attributes during init",
        ...
        "check_do_not_raise_errors_in_init_or_set_params": "ComplementNB raises errors in init or set_params",
        ...
        "check_sample_weights_list": "ComplementNB does not handle list sample weights",
        ...
        "check_complex_data": "ComplementNB does not handle complex data",
        ...
        "check_parameters_default_constructible": "ComplementNB parameters are mutated on init",
        "check_fit_check_is_fitted": "ComplementNB passes check_is_fitted before being fit",
        "check_fit1d": "ComplementNB does not raise ValueError for 1D input",
    ...
    CategoricalNB: {
        "check_estimator_tags_renamed": "No support for modern tags infrastructure",
        "check_no_attributes_set_in_init": "CategoricalNB sets attributes during init",
        ...
        "check_do_not_raise_errors_in_init_or_set_params": "CategoricalNB raises errors in init or set_params",
        ...
        "check_sample_weights_list": "CategoricalNB does not handle list sample weights",
        ...
        "check_complex_data": "CategoricalNB does not handle complex data",
        ...
        "check_parameters_default_constructible": "CategoricalNB parameters are mutated on init",
        "check_methods_sample_order_invariance": "CategoricalNB methods not invariant to sample order",
        "check_methods_subset_invariance": "CategoricalNB methods not invariant to subset operations",
        "check_fit2d_1sample": "CategoricalNB does not handle single sample gracefully",
        "check_fit2d_1feature": "CategoricalNB does not handle single feature gracefully",
        "check_dict_unchanged": "CategoricalNB modifies input parameters",
        "check_fit_idempotent": "CategoricalNB fit is not idempotent",
        "check_fit_check_is_fitted": "CategoricalNB passes check_is_fitted before being fit",
        "check_n_features_in": "CategoricalNB does not set n_features_in_ properly",
        "check_fit1d": "CategoricalNB does not raise ValueError for 1D input",
    ...
    MultinomialNB: {
        "check_estimator_tags_renamed": "No support for modern tags infrastructure",
        "check_no_attributes_set_in_init": "MultinomialNB sets attributes during init",
        "check_estimators_unfitted": "MultinomialNB does not raise NotFittedError before fit",
        "check_do_not_raise_errors_in_init_or_set_params": "MultinomialNB raises errors in init or set_params",
        ...
        "check_sample_weights_list": "MultinomialNB does not handle list sample weights",
        ...
        "check_complex_data": "MultinomialNB does not handle complex data",
        ...
        "check_parameters_default_constructible": "MultinomialNB parameters are mutated on init",
        "check_methods_sample_order_invariance": "MultinomialNB methods not invariant to sample order",
        "check_methods_subset_invariance": "MultinomialNB methods not invariant to subset operations",
        "check_fit2d_1sample": "MultinomialNB does not handle single sample gracefully",
        "check_fit2d_1feature": "MultinomialNB does not handle single feature gracefully",
        "check_dict_unchanged": "MultinomialNB modifies input parameters",
        "check_fit_idempotent": "MultinomialNB fit is not idempotent",
        "check_fit_check_is_fitted": "MultinomialNB passes check_is_fitted before being fit",
        "check_n_features_in": "MultinomialNB does not set n_features_in_ properly",
        "check_fit1d": "MultinomialNB does not raise ValueError for 1D input",
