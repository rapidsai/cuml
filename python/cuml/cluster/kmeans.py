...
from cuml.common.input_utils import input_to_multi_gpu
...
class KMeans():
    ...
    def init(execution_type):
        if self.execution_type == 'SG':
            self.kmeans_obj = sgKmeans(n_clusters=self.n_clusters,
