...
def test_rf_classification(datatype, array_type, max_features, rows_sample, fixture):
...
def test_rf_classification_multi_class(mclass_clf, datatype, array_type):
    test_rf_classification(datatype, array_type, 1.0, 1.0, mclass_clf)
...
def test_rf_classification_proba(small_clf, datatype,
                                 rows_sample, max_features):
    test_rf_classification(datatype, 'numpy', max_features, rows_sample,
                           small_clf)
