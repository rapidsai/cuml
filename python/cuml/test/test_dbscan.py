...
def test_dbscan_unit(datatype, input_type, use_handle, max_bytes_per_batch):
...
@pytest.mark.parametrize('input_type', ['dataframe', 'ndarray'])
@pytest.mark.parametrize('use_handle', [True, False])
def test_dbscan_quality(datatype, input_type, use_handle, max_bytes_per_batch):
    # max_bytes_per_batch sizes: 10=6 batches, 200=2 batches, 2e6=1 batch
    n_samples = 5000
    n_feats = 100
...
@pytest.mark.parametrize('input_type', ['dataframe', 'ndarray'])
@pytest.mark.parametrize('use_handle', [True, False])
def test_dbscan_stress(datatype, input_type, use_handle, max_bytes_per_batch):
    # max_bytes_per_batch sizes: 10=6 batches, 200=2 batches, 2e6=1 batch
    n_samples = 500000
    n_feats = 1000
    X, y = make_blobs(n_samples=n_samples,
...
@pytest.mark.parametrize("name", [
                                 ...
                                 'blobs',
                                 'no_structure'])
def test_dbscan_sklearn_comparison_unit(name):
...
@pytest.mark.parametrize("name", [
                                 ...
                                 'blobs',
                                 'no_structure'])
def test_dbscan_sklearn_comparison_quality(name):
    default_base = {'quantile': .3,
                    'eps': .3,
                    'damping': .9,
                    'preference': -200,
...
@pytest.mark.parametrize("name", [
                                 ...
                                 'blobs',
                                 'no_structure'])
def test_dbscan_sklearn_comparison_stress(name):
    default_base = {'quantile': .3,
                    'eps': .3,
                    'damping': .9,
                    'preference': -200,
