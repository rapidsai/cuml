...
def test_tsne():
    ...
    for i in range(3):
        ...
        tsne = TSNE(n_components = 2, random_state = i, verbose = 0, learning_rate = 200 + i)
        ...
        # Again
        tsne = TSNE(n_components = 2, random_state = i + 2, verbose = 1, learning_rate = 200 + i + 2)
        ...
        # Again
        tsne = TSNE(n_components = 2, random_state = i + 4, verbose = 0, learning_rate = 200 + i + 4)
