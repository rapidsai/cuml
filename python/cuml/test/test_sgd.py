...
@pytest.mark.parametrize('learning_rate', ['constant', 'invscaling', 'adaptive'])
...
def test_svd(datatype, learning_rate, input_type, penalty, loss):
    ...
    sk_sgd = SGDClassifier(learning_rate=learning_rate, eta0=0.005,
    ...
    cu_sgd = cumlSGD(learning_rate=learning_rate, eta0=0.005, epochs=2000,
