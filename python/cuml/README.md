...
For developers that need to modify RAFT code, please refer to the [RAFT Developer Guide](https://github.com/rapidsai/raft/blob/release/26.08/docs/source/build.md) for recommendations.
...
cuML's convenience [development yaml files](https://github.com/rapidsai/cuml/tree/release/26.08/environments) includes all dependencies required to build cuML.
