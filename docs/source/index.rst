...
cuML is a suite of fast NVIDIA GPU accelerated machine learning algorithms
designed for data science and analytical tasks. Our API mirror's Sklearn's,
...
RAPIDS provides users a streamlined approach where data is directly loaded
