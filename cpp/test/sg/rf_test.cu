...
const std::vector<RfInputs<float>> inputsf2_clf = {
  ...
  {4, 2, 10, 0.8f, 0.8f, 4, 7, -1, true, false, 3, 2, 2, 0.0, 2,
   CRITERION::ENTROPY},
  {4, 2, 10, 0.8f, 0.8f, 4, 7, -1, true, false, 3, 1, 2, 0.0, 2,
   CRITERION::ENTROPY},
  {50, 10, 10, 0.8f, 0.8f, 10, 7, -1, true, true, 3, 2, 2, 0.0, 2,
   CRITERION::ENTROPY}};
