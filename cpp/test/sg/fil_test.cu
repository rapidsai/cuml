...
// global_bias, algo, blocks_per_sm, seed, tolerance, branch comparison operator, FIL implementation, number of classes
std::vector<FilTestParams> predict_dense_inputs = {
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0, fil::algo_t::NAIVE,
   0, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::TREE_REORG, 1, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::NAIVE, 0, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::TREE_REORG, 1, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  ...
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0.5,
   fil::algo_t::TREE_REORG, 0, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0.5,
   fil::algo_t::BATCH_TREE_REORG, 1, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0.5, fil::algo_t::NAIVE,
   2, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 1.0, 0.5,
   fil::algo_t::TREE_REORG, 0, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::ALGO_AUTO, 1, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator(0),
  ...
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   ...
   fil::leaf_algo_t::CATEGORICAL_LEAF, 5},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::NAIVE, 2, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::CATEGORICAL_LEAF, 7},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0.5,
   fil::algo_t::TREE_REORG, 0, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::CATEGORICAL_LEAF, 4},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0.5, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::CATEGORICAL_LEAF, 4},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator(0),
...
std::vector<FilTestParams> predict_sparse_inputs = {
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::NAIVE, 2, 42, 2e-3f, tl::Operator(0),
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
  ...
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0.5, fil::algo_t::NAIVE,
   0, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::CATEGORICAL_LEAF, 6},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::CLASS, 0, 0, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::CATEGORICAL_LEAF, 3},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0, fil::algo_t::NAIVE,
   2, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::CATEGORICAL_LEAF, 3},
  ...
  {20000, 50, 0.05, 8, 60, 0.05, fil::output_t::RAW, 0, 0.5, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::GROVE_PER_CLASS, 6},
  {20000, 50, 0.05, 8, 51, 0.05, fil::output_t::CLASS, 0, 0, fil::algo_t::NAIVE,
   2, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::GROVE_PER_CLASS, 3},
  {20000, 50, 0.05, 8, 51, 0.05, fil::output_t::RAW, 0, 0, fil::algo_t::NAIVE,
   0, 42, 2e-3f, tl::Operator(0), fil::leaf_algo_t::GROVE_PER_CLASS, 3},
};
...
std::vector<FilTestParams> import_dense_inputs = {
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator::kLT, fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::NAIVE, 2, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::SIGMOID | fil::output_t::CLASS), 0, 0,
   fil::algo_t::NAIVE, 0, 42, 2e-3f, tl::Operator::kGT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator::kGE, fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 0, 0,
   fil::algo_t::NAIVE, 2, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::TREE_REORG, 0, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::TREE_REORG, 1, 42, 2e-3f, tl::Operator::kGT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::SIGMOID | fil::output_t::CLASS), 0, 0,
   fil::algo_t::TREE_REORG, 2, 42, 2e-3f, tl::Operator::kGE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0,
   fil::algo_t::TREE_REORG, 0, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 0, 0,
   fil::algo_t::TREE_REORG, 1, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 0, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 1, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 0, 42, 2e-3f, tl::Operator::kGT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 1, 42, 2e-3f, tl::Operator::kGT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator::kGE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 0, 42, 2e-3f, tl::Operator::kGE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::SIGMOID | fil::output_t::CLASS), 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 1, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::SIGMOID | fil::output_t::CLASS), 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator::kLE,
  ...
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator::kGT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 0, 42, 2e-3f, tl::Operator::kGE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0.5,
   fil::algo_t::TREE_REORG, 1, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0.5,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0.5, fil::algo_t::NAIVE,
   0, 42, 2e-3f, tl::Operator::kGT, fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 1.0, 0.5,
   fil::algo_t::TREE_REORG, 1, 42, 2e-3f, tl::Operator::kGE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::ALGO_AUTO, 2, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::ALGO_AUTO, 0, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 1, 42, 2e-3f, tl::Operator::kGE,
   fil::leaf_algo_t::CATEGORICAL_LEAF, 5},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 2, 42, 2e-3f, tl::Operator::kGT,
   fil::leaf_algo_t::CATEGORICAL_LEAF, 6},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0,
   fil::algo_t::BATCH_TREE_REORG, 0, 42, 2e-3f, tl::Operator::kLE,
  ...
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 0, 0,
   fil::algo_t::TREE_REORG, 2, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::CATEGORICAL_LEAF, 5},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0,
   fil::algo_t::TREE_REORG, 0, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::CATEGORICAL_LEAF, 7},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator::kLT, fil::leaf_algo_t::CATEGORICAL_LEAF, 6},
  ...
  {20000, 50, 0.05, 8, 48, 0.05, fil::output_t::CLASS, 0, 0, fil::algo_t::NAIVE,
   2, 42, 2e-3f, tl::Operator::kLT, fil::leaf_algo_t::GROVE_PER_CLASS, 6},
};
...
std::vector<FilTestParams> import_sparse_inputs = {
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0, fil::algo_t::NAIVE,
   0, 42, 2e-3f, tl::Operator::kLT, fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0,
   fil::algo_t::NAIVE, 1, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::SIGMOID | fil::output_t::CLASS), 0, 0,
   fil::algo_t::NAIVE, 2, 42, 2e-3f, tl::Operator::kGT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0, fil::algo_t::NAIVE,
   0, 42, 2e-3f, tl::Operator::kGE, fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 0, 0,
   fil::algo_t::NAIVE, 1, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0.5, fil::algo_t::NAIVE,
   2, 42, 2e-3f, tl::Operator::kLT, fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::SIGMOID, 0, 0.5,
   fil::algo_t::NAIVE, 0, 42, 2e-3f, tl::Operator::kLE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0.5, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator::kGT, fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 1.0, 0.5,
   fil::algo_t::NAIVE, 2, 42, 2e-3f, tl::Operator::kGE,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 2},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::ALGO_AUTO, 0, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  {20000, 50, 0.05, 8, 50, 0.05,
   fil::output_t(fil::output_t::AVG | fil::output_t::CLASS), 1.0, 0.5,
   fil::algo_t::NAIVE, 1, 42, 2e-3f, tl::Operator::kGE,
   fil::leaf_algo_t::CATEGORICAL_LEAF, 10},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0,
   fil::algo_t::ALGO_AUTO, 2, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::CATEGORICAL_LEAF, 4},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0, fil::algo_t::NAIVE,
   0, 42, 2e-3f, tl::Operator::kLE, fil::leaf_algo_t::CATEGORICAL_LEAF, 5},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::AVG, 0, 0.5, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator::kLT, fil::leaf_algo_t::CATEGORICAL_LEAF, 3},
  ...
  {20000, 50, 0.05, 8, 52, 0.05, fil::output_t::CLASS, 0, 0,
   ...
   fil::leaf_algo_t::GROVE_PER_CLASS, 4},
  {20000, 50, 0.05, 8, 50, 0.05, fil::output_t::CLASS, 0, 0, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator::kLE, fil::leaf_algo_t::GROVE_PER_CLASS, 5},
...
std::vector<FilTestParams> import_auto_inputs = {
  ...
  {20000, 50, 0.05, 15, 50, 0.05, fil::output_t::RAW, 0, 0,
   fil::algo_t::ALGO_AUTO, 1, 42, 2e-3f, tl::Operator::kLT,
   fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
...
std::vector<FilTestParams> import_throw_sparse8_inputs = {
  ...
  {100, 20000, 0.05, 10, 50, 0.05, fil::output_t::RAW, 0, 0, fil::algo_t::NAIVE,
   1, 42, 2e-3f, tl::Operator::kLT, fil::leaf_algo_t::FLOAT_UNARY_BINARY, 1},
  // too many tree nodes
  {20000, 50, 0.05, 16, 5, 0, fil::output_t::RAW, 0, 0, fil::algo_t::NAIVE, 2,
