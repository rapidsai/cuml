 ...
 *
 * @return CUML_SUCCESS on success,
 * @todo   Add more error codes
 */
cumlError_t cumlCreate(cumlHandle_t* handle);

/**
 * Sets the stream to which all cuML work issued via the passed handle should be
 * ordered.
 *
...
/**
 * Gets the stream to which all cuML work issued via the passed handle should be
 * ordered.
 *
 * @param[inout] handle handle to get the stream of.
 * @param[out]   stream pointer to the stream to which cuML work should be
 *                      ordered.
 *
 * @return CUML_SUCCESS on success,
 * @todo   Add more error codes
 ...
 * @param[in]    allocate_fn   function pointer to the allocate function to use
 *                             for device allocations.
 * @param[in]    deallocate_fn function pointer to the deallocate function to
 *                             use for device allocations.
 *
 * @return CUML_SUCCESS on success,
 * @todo   Add more error codes
 */
