...
/**
 * Parameters for kernel matrices. The following kernels are implemented:
 * - LINEAR
 * @f[ K(x_1,x_2) = <x_1,x_2>,
 * @f] where
 * @f$< , >\f$ is the dot product
 * - POLYNOMIAL
 * @f[ K(x_1, x_2) = (\gamma <x_1,x_2> + \mathrm{coef0})^\mathrm{degree}
 * @f]
 * - RBF
 * @f[ K(x_1, x_2) = \exp(- \gamma |x_1-x_2|^2)
 * @f]
 * - TANH
 * @f[ K(x_1, x_2) = \tanh(\gamma <x_1,x_2> + \mathrm{coef0})
 * @f]
 */
struct KernelParams {
