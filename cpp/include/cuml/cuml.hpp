...
class cumlHandle {
 public:
  /**
     ...
     * @param n_streams number of worker streams to be setup
     *
  ...
  */
  ...
  /**
   * @brief API to get the worker streams as a vector.
   * @return vector of worker streams in the handle
   */
   ...
   */
  std::vector<cudaStream_t> getInternalStream(int sid) const;
