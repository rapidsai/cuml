...
struct decision_forest {
   ...
   * The bias term should have same length as num_outputs.
   ...
   * type of inference. Note: This will differ from num_outputs argument
   * passed to the constructor, if inference_kind is not default_kind.
   */
