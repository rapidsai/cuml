...
struct KMeansParams {
  enum InitMethod {
    ...
    Random,
    /// (ndarray): Use 'centroids' as initial cluster centers.
    Array
  };
...
/**
 * @defgroup KMeansClusteringFitPredict K-Means Clustering - Fit/Predict function
 *
 * Compute k-means clustering and predicts cluster index for each sample in the
 * input.
 *
 ...
 *                             stored in device accessible location.
 ...
 *                             centroids  as the initial cluster centers [out]
 *                             Otherwise, generated centroids from the kmeans
 *                             algorithm is stored at the address pointed by
 *                             'centroids'.
...
/**
 * @defgroup KMeansClusteringFit K-Means Clustering - Fit function
 *
...
/**
 * @defgroup KMeansClusteringPredict K-Means Clustering - Predict function
 *
...
/**
 * @defgroup KMeansClusteringTransform K-Means Clustering - Transform function
 *
