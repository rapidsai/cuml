                ...
                cudaStream_t stream)
{
  ...
  for (int i = n_batches - 1; i >= 0; i--) {
    ...
    raft::common::push_nvtx_range("Trace::Dbscan::VertexDeg");
    ...
    raft::common::push_nvtx_range("Trace::Dbscan::CorePoints");
  ...
  for (int i = 0; i < n_batches; i++) {
    ...
    raft::common::push_nvtx_range("Trace::Dbscan::AdjGraph");
    ...
    raft::common::push_nvtx_range("Trace::Dbscan::WeakCC");
    ...
    if (i > 0) {
      ...
      raft::common::push_nvtx_range("Trace::Dbscan::MergeLabels");
  ...
  // Final relabel
  if (my_rank == 0) {
    raft::common::push_nvtx_range("Trace::Dbscan::FinalRelabel");
    ...
    if (core_indices != nullptr) {
      raft::common::nvtx_range fun_scope("Trace::Dbscan::CoreSampleIndices");
