...
void dbscanFitImpl(const ML::cumlHandle_impl &handle, T *input, Index_ n_rows,
                   Index_ n_cols, T eps, Index_ min_pts, Index_ *labels, Index_ *core_sample_indices,
  ...
  size_t workspaceSize =
    Dbscan::run(handle, input, n_rows, n_cols, eps, min_pts, labels, core_sample_indices, algoVd,
