 ...
 * @param scalar scalar to scale vector with
 * @param in_m matrix in which the vector is supposed to be added
 * @param v vector to be scaled and added
 * @param out_m final added matrix generated by ver dan merwe method
 * @note All the matrices are assumed to be stored in col major form
