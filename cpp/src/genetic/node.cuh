...
DI float evaluate_node(const node& n, const float* data, size_t stride, float inval, float inval1)
{
  if (n.t == node::type::constant) {
    ...
    switch (n.t) {
      ...
      case node::type::max: return fmaxf(inval, inval1);
      case node::type::min: return fminf(inval, inval1);
      case node::type::mul: return inval * inval1;
      case node::type::pow: return powf(inval, inval1);
      case node::type::sub: return inval - inval1;
      // unary operators
      case node::type::abs: return abs_inval;
      case node::type::acos: return acosf(inval);
      case node::type::acosh: return acoshf(inval);
      case node::type::asin: return asinf(inval);
      case node::type::asinh: return asinhf(inval);
      case node::type::atan: return atanf(inval);
      case node::type::atanh: return atanhf(inval);
      case node::type::cbrt: return cbrtf(inval);
      case node::type::cos: return cosf(inval);
      case node::type::cosh: return coshf(inval);
      case node::type::cube: return inval * inval * inval;
      case node::type::exp: return expf(inval);
      case node::type::inv: return abs_inval < MIN_VAL ? 0.f : 1.f / inval;
      case node::type::log: return abs_inval < MIN_VAL ? 0.f : logf(abs_inval);
      case node::type::neg: return -inval;
      case node::type::rcbrt: return rcbrtf(inval);
      case node::type::rsqrt: return rsqrtf(abs_inval);
      case node::type::sin: return sinf(inval);
      case node::type::sinh: return sinhf(inval);
      case node::type::sq: return inval * inval;
