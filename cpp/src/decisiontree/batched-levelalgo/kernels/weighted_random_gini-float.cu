...
using _LabelT     = int;
using _IdxT       = int;
using _ObjectiveT = WeightedGiniObjectiveFunction<_DataT, _LabelT, _IdxT>;
...
// instantiation of launchRandomSplitKernel on the weighted-classifier path.
#define INSTANTIATE_TREE_CLASS_WEIGHT
#include "builder_random_kernels_impl.cuh"
