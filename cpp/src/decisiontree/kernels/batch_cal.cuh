...
int get_batch_cols_cnt(const size_t avail_shared_memory,
                       const size_t requested_shared_memory, const int ncols) {
...
void update_kernel_config(const size_t avail_shared_memory,
                          const size_t requested_shared_memory, const int ncols,
                          const int nrows, const int threads, int& batch_ncols,
                          int& blocks, size_t& shmemsize) {
  batch_ncols =
    get_batch_cols_cnt(avail_shared_memory, requested_shared_memory, ncols);
  shmemsize =
