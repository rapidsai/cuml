...
void validity_check(const DecisionTreeParams params)
{
  ...
  ASSERT((params.max_features > 0) && (params.max_features <= 1.0),
         ...
         params.max_features);
  ASSERT((params.max_nbins > 0), "Invalid max_nbins %d", params.max_nbins);
  ASSERT((params.max_nbins <= 1024), "max_nbins should not be larger than 1024");
                     ...
                     int cfg_max_batch_size)
{
  ...
  params.max_nbins             = cfg_max_nbins;
