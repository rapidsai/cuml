                    ...
                    value_type* eigenvectors)
{
  ...
  raft::device_vector_view<index_type, uint32_t, raft::row_major> rows_view =
    raft::make_device_vector_view<index_type, uint32_t, raft::row_major>(rows, n + 1);
  raft::device_vector_view<index_type, uint32_t, raft::row_major> cols_view =
    raft::make_device_vector_view<index_type, uint32_t, raft::row_major>(cols, nnz);
  raft::device_vector_view<value_type, uint32_t, raft::row_major> vals_view =
    raft::make_device_vector_view<value_type, uint32_t, raft::row_major>(vals, nnz);
  raft::device_vector_view<value_type, uint32_t, raft::row_major> v0_view =
    raft::make_device_vector_view<value_type, uint32_t, raft::row_major>(v0, n);
  raft::device_vector_view<value_type, uint32_t, raft::col_major> eigenvalues_view =
    raft::make_device_vector_view<value_type, uint32_t, raft::col_major>(eigenvalues, n_components);
  raft::device_matrix_view<value_type, uint32_t, raft::col_major> eigenvectors_view =
    raft::make_device_matrix_view<value_type, uint32_t, raft::col_major>(
...
void lanczos_solver(const raft::handle_t& handle,
                    ...
                    double* eigenvectors)
{
  lanczos_solver<int, double>(handle,
                              rows,
                              cols,
                              vals,
                              nnz,
...
void lanczos_solver(const raft::handle_t& handle,
                    ...
                    float* eigenvectors)
{
  lanczos_solver<int, float>(handle,
                             rows,
                             cols,
                             vals,
                             nnz,
...
void old_lanczos_solver(const raft::handle_t& handle,
                        ...
                        float* eigenvectors)
{
  old_lanczos_solver<int, float>(handle,
                                 rows,
                                 cols,
                                 vals,
                                 nnz,
...
void old_lanczos_solver(const raft::handle_t& handle,
                        ...
                        double* eigenvectors)
{
  old_lanczos_solver<int, double>(handle,
                                  rows,
                                  cols,
                                  vals,
                                  nnz,
