...
/**
 * @brief perform fit operation for the tsvd. Generates eigenvectors, explained
 *        vars, singular vals, etc.
 *
 * @param[in]  handle        the internal cuml handle object
 * @param[in]  input         the data is fitted to PCA. Size n_rows x n_cols.
 *                           The size of the data is indicated in prms.
 * @param[out] components    the principal components of the input data. Size
 *                           n_cols * n_components.
...
/**
 * @brief performs fit and transform operations for the tsvd. Generates
 *        transformed data, eigenvectors, explained vars, singular vals, etc.
 *
 * @param[in]  handle              the internal cuml handle object
 * @param[in]  input               the data is fitted to PCA. Size n_rows x
 *                                 n_cols. The size of the data is indicated in
 *                                 prms.
 * @param[out] trans_input         the transformed data. Size n_rows *
 *                                 n_components.
 * @param[out] components          the principal components of the input data.
 *                                 Size n_cols * n_components.
 * @param[out] explained_var       explained variances (eigenvalues) of the
 *                                 principal components. Size n_components * 1.
 * @param[out] explained_var_ratio the ratio of the explained variance and total
 *                                 variance. Size n_components * 1.
 * @param[out] singular_vals       singular values of the data. Size
 *                                 n_components * 1
...
/**
 * @brief performs transform operation for the tsvd. Transforms the data to
 *        eigenspace.
 *
 * @param[in]  handle      the internal cuml handle object
 * @param[in]  input       the data is transformed. Size n_rows x n_components.
 * @param[in]  components  principal components of the input data. Size n_cols *
 *                         n_components.
...
/**
 * @brief performs inverse transform operation for the tsvd. Transforms the
 *        transformed data back to original data.
 *
 * @param[in]  handle      the internal cuml handle object
 * @param[in]  trans_input the data is fitted to PCA. Size n_rows x
 *                         n_components.
 * @param[in]  components  transpose of the principal components of the input
 *                         data. Size n_components * n_cols.
