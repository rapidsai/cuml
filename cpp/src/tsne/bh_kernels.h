...
void BoundingBoxKernel(int * restrict startd, 
                        int * restrict childd, 
...
void ClearKernel1(int * restrict childd)
{
...
void TreeBuildingKernel(volatile int * restrict errd, 
                        int * restrict childd, 
...
__global__
__launch_bounds__(1024, 1)
void ClearKernel2(int * restrict startd, float * restrict massd)
{
...
void SummarizationKernel(int * restrict countd, 
...
void SortKernel(int * restrict sortd, const int * restrict countd, 
                volatile int * restrict startd, int * restrict childd)
{
    const int bottom = (int) bottomd;
...
void RepulsionKernel(int * restrict errd, 
                    const float theta, 
            ...
            do {
                ...
                while (pd < 4) {
                    ...
                    if (n >= 0) {
                        ...
                        register float tmp = dx*dx + dy*dy + epssqd; // distance squared plus small constant to prevent zeros
                    ...
                    const int NNZ)
{
    ...
    const float PQ =  __fdividef(VAL[index],
