...
__global__ void
attractive_kernel(const float *restrict VAL,
...
__global__ void
attractive_kernel_2d(const float *restrict VAL,
                    const int *restrict COL,
                    const int *restrict ROW,
...
/****************************************/
void
attractive_forces(const float *restrict VAL,
                const int *restrict COL,
                const int *restrict ROW,
                const float *restrict Y,
                const float *restrict norm,
...
__global__ void
repulsive_kernel(const float *restrict Y,
...
__global__ void
repulsive_kernel_2d(const float *restrict Y1,
                    const float *restrict Y2,
...
repulsive_forces(const float *restrict Y,
                float *restrict repel,
                const float *restrict norm,
