...
namespace Metrics {
void pairwise_distance_cosine(const raft::handle_t &handle, const double *x,
  ...
  switch (metric) {
    case raft::distance::DistanceType::CosineExpanded:
      raft::distance::pairwise_distance_impl<
        double, int, raft::distance::DistanceType::CosineExpanded>(
...
void pairwise_distance_cosine(const raft::handle_t &handle, const float *x,
  ...
  switch (metric) {
    case raft::distance::DistanceType::CosineExpanded:
      raft::distance::pairwise_distance_impl<
        float, int, raft::distance::DistanceType::CosineExpanded>(
        x, y, dist, m, n, k, workspace, handle.get_stream(), isRowMajor);
      break;
    default:
      THROW("Unknown or unsupported distance metric '%d'!", (int)metric);
