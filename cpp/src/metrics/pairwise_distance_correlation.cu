                                ...
                                double metric_arg)
{
  ...
  switch (metric) {
    case raft::distance::DistanceType::CorrelationExpanded:
      raft::distance::pairwise_distance_impl<double, int, raft::distance::DistanceType::CorrelationExpanded>(
                                ...
                                float metric_arg)
{
  ...
  switch (metric) {
    case raft::distance::DistanceType::CorrelationExpanded:
      raft::distance::pairwise_distance_impl<float, int, raft::distance::DistanceType::CorrelationExpanded>(
        x, y, dist, m, n, k, workspace, handle.get_stream(), isRowMajor);
      break;
    default: THROW("Unknown or unsupported distance metric '%d'!", (int)metric);
  }
