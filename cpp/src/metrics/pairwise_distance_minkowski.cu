...
namespace Metrics {
void pairwise_distance_minkowski(const raft::handle_t &handle, const double *x,
  ...
  switch (metric) {
    case raft::distance::DistanceType::LpUnexpanded:
      raft::distance::pairwise_distance_impl<
        double, int, raft::distance::DistanceType::LpUnexpanded>(
...
void pairwise_distance_minkowski(const raft::handle_t &handle, const float *x,
  ...
  switch (metric) {
    case raft::distance::DistanceType::LpUnexpanded:
      raft::distance::pairwise_distance_impl<
        float, int, raft::distance::DistanceType::LpUnexpanded>(
        x, y, dist, m, n, k, workspace, handle.get_stream(), isRowMajor,
        metric_arg);
      break;
    default:
