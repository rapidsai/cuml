...
namespace Metrics {
void pairwise_distance_l1(const raft::handle_t &handle, const double *x,
  ...
  switch (metric) {
    case raft::distance::DistanceType::L1:
      raft::distance::pairwise_distance_impl<double, int,
...
void pairwise_distance_l1(const raft::handle_t &handle, const float *x,
  ...
  switch (metric) {
    case raft::distance::DistanceType::L1:
      raft::distance::pairwise_distance_impl<float, int,
                                             raft::distance::DistanceType::L1>(
        x, y, dist, m, n, k, workspace, handle.get_stream(), isRowMajor);
      break;
    default:
