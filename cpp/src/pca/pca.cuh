...
/**
 * @brief perform fit operation for the pca. Generates eigenvectors, explained
 ...
 *                                 n_components * 1
 * @param[out] mu                  mean of all the features (all the columns in
 *                                 the data). Size n_cols * 1.
...
/**
 * @brief perform fit and transform operations for the pca. Generates
...
/**
 * @brief performs inverse transform operation for the pca. Transforms the
...
/**
 * @brief performs transform operation for the pca. Transforms the data to
 *        eigenspace.
 *
 * @param[in]  handle        the internal cuml handle object
 * @param[in]  input         the data is transformed. Size n_rows x
 *                           n_components.
