...
Notebook](https://github.com/rapidsai/cuml/tree/release/26.02/notebooks/tools).
...
example [walkthrough
notebooks](https://github.com/rapidsai/cuml/tree/release/26.02/notebooks). Finally, you
