...
Notebook](https://github.com/rapidsai/cuml/tree/release/26.06/notebooks/tools).
...
example [walkthrough
notebooks](https://github.com/rapidsai/cuml/tree/release/26.06/notebooks). Finally, you
