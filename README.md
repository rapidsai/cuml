...
Notebook](https://github.com/rapidsai/cuml/tree/release/26.08/notebooks/tools).
...
example [walkthrough
notebooks](https://github.com/rapidsai/cuml/tree/release/26.08/notebooks). Finally, you
