...
Notebook](https://github.com/rapidsai/cuml/tree/release/26.04/notebooks/tools).
...
example [walkthrough
notebooks](https://github.com/rapidsai/cuml/tree/release/26.04/notebooks). Finally, you
