...
than their CPU equivalents. For details on performance, see the [cuML Benchmarks Notebook](https://github.com/rapidsai/cuml/blob/branch-0.16/notebooks/tools/cuml_benchmarks.ipynb).
...
introductory [walkthrough notebooks](https://github.com/rapidsai/cuml/tree/branch-0.16/notebooks). Finally, you
