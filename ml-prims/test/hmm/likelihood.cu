...
void allocate_memory(){
        ...
        allocate(ps_d, nTests * nCl);
        CUDA_CHECK(cudaMemset(ps_d, (T) 0, nTests * nCl));
        ps_h = (T *)malloc(nTests * nCl * sizeof(T));
...
void copy_to_device(){
        ...
        updateDevice(ps_d, ps_h, nCl * nTests);
