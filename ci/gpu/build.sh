...
source activate gdf
conda install cudf=${CUDF_VERSION} rmm=${RMM_VERSION} nvstrings=${NVSTRINGS_VERSION} lapack cmake==3.14.3 umap-learn libclang cupy "conda-forge::blas=*=openblas" scikit-learn=0.21
