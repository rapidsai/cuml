...
pytest --cache-clear --junitxml=${WORKSPACE}/junit-cuml.xml cuml/test/test_random_forest.py::test_rf_memory_leakage cuml/test/test_svm.py::test_svm_memleak -v -s
